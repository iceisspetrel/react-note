...
/////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////
// 节点上 style的写法  style后需要插入Object对象，并且采用驼峰标识写法
// html插入写法      dangerouslySetInnerHTML={{__html : "<span></span>"}}, 为了防止XSS攻击，react默认会转译
this.render = function(){
    var html = "<span>ccccccccccccccccc</span>"
    return (
        <div className="commentBox" style={{"color" : "red", "fontSize": "15px", "marginLeft" : "100px"}}>
            Hi, I am a react CommentBox.{this.props.name}{this.props.age}
